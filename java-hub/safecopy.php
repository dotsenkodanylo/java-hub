...
text-decoration: none;
   ...
   { position: relative;
    ...
    background-image: linear-gradient(to bottom right, #1a0d00, #663300, #cc9966 );
    opacity: 0.75;
...
[
  ...
  },
  {
        ...
        var infowindow = new google.maps.InfoWindow({ maxWidth: 720 });
...
if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            marker.addListener('click', function() {
                ...
                infowindow.setContent(marker.title + "Sniff");
        ...
        for(cafe of coffeeMarkers) {                                    //Loop through ALL entries; if need to make array of names, here is where to extract a singular variable
              ...
              title: cafe.name,
              content: "<br>" + "<a href='" + cafe.page + "'target='_blank'>Homepage</a><br></div>",
              visible: false,
              icon: 'bean2.png',
              ...
              marker.addListener('click', function() {
                ...
                //map.setZoom(15);
                map.panTo(marker.getPosition());
                infowindow.setContent("<div style='height: 20vw;'>" + "<strong>" + marker.title + "</strong>" + marker.content + "</div>");
                infowindow.open(map, this);  
              });   
